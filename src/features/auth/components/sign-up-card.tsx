...
import { TriangleAlert, User, AtSign, KeyRound, LogIn } from 'lucide-react'
      ...
      <div className="relative hidden flex-col items-center justify-center bg-emerald-400 p-12 text-center lg:flex">
        ...
        <div className="relative z-10 space-y-8">
          ...
          <div className="relative mt-8">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <path d="M4 15s1-1 4-1 4 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z" />
        ...
        <div className="relative z-10 mt-auto flex gap-1">
          {[...Array(5)].map((_, i) => (
            <div
              key={i}
              className={`size-2 rounded-full ${i === 1 ? 'bg-white' : 'bg-white/40'}`}
              role="presentation"
            />
          ))}
        </div>
            ...
            <form onSubmit={handleSignUp} className="space-y-4">
              <div className="space-y-4">
                <div className="relative">
                  ...
                  />
                  <User className="absolute left-3 top-3 h-6 w-6 text-white/50" />
                </div>
                <div className="relative">
                  <Input
                    disabled={pending}
